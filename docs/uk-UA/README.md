...
[![Guides](https://img.shields.io/badge/Guides-Start%20here-1f6feb?logo=readme&logoColor=white)](#посібники)
...
<td width="25%" align="center">
  <a href="https://ecc.tools/pricing">
    ...
    <sub>Приватні репо · GitHub App · $19/місць/міс</sub>
  </a>
</td>
<td width="25%" align="center">
  <a href="https://github.com/sponsors/affaan-m">
    <strong>❤️ Спонсор</strong><br />
    <sub>Підтримати OSS · Від $5/міс</sub>
  </a>
</td>
<td width="25%" align="center">
  <a href="https://github.com/affaan-m/ECC/discussions">
    ...
    <br />
    <sub>Обговорення · Питання та відповіді · Демонстрація</sub>
  </a>
</td>
<td width="25%" align="center">
  <a href="https://github.com/apps/ecc-tools">
    <strong>🤖 GitHub App</strong><br />
    <sub>Встановлення · Аудит PR · Безкоштовний рівень</sub>
  </a>
</td>
</tr>
</table>
...
<sub><strong>Бізнес-спонсори</strong></sub>
...
<img src="../../assets/images/shortform/00-header.png" width="420" alt="Короткий посібник з ECC" /><br />
<b>Короткий посібник</b>
</a>
<br /><sub>Налаштування, основи, філософія. <b>Читайте спочатку.</b> (<a href="https://x.com/affaan/status/2012378465664745795">нитка</a>)</sub>
</td>
<td width="50%" align="center">
<a href="../../the-longform-guide.md">
<img src="../../assets/images/longform/01-header.png" width="420" alt="Розширений посібник з ECC" /><br />
<b>Розширений посібник</b>
</a>
<br /><sub>Оптимізація токенів, збереження пам'яті, оцінки, паралелізація. (<a href="https://x.com/affaan/status/2014040193557471352">нитка</a>)</sub>
</td>
</tr>
</table>
...
<img src="../../assets/images/security/security-guide-header.png" width="420" alt="Короткий посібник з усього, що стосується безпеки агентів" /><br />
<b>Посібник з безпеки</b>
</a>
<br /><sub>Вектори атак, пісочниця, санітизація, CVE, AgentShield. (<a href="https://x.com/affaan/status/2033263813387223421">нитка</a>)</sub>
</div>
...
<details>
<summary><b>Як перевірити, які агенти/команди встановлено?</b></summary>
...
<details>
<summary><b>Мої хуки не працюють / я бачу помилки "Duplicate hooks file"</b></summary>
...
<details>
<summary><b>Чи можна використовувати ECC з Claude Code на власному API-ендпоінті або шлюзі моделей?</b></summary>
...
<details>
<summary><b>Моє контекстне вікно скорочується / Claude вичерпує контекст</b></summary>
...
<details>
<summary><b>Чи можу я використовувати лише деякі компоненти (наприклад, лише агентів)?</b></summary>

Так. Використовуйте Варіант 2 (ручне встановлення) та скопіюйте лише те, що вам потрібно. Кожен компонент повністю незалежний.
</details>

<details>
<summary><b>Чи це працює з Cursor / OpenCode / Codex / Antigravity / GitHub Copilot?</b></summary>

Так. ECC є кросплатформним. Дивіться відповідні розділи нижче для деталей кожної оболонки.
</details>

<details>
<summary><b>Як зробити внесок новою навичкою або агентом?</b></summary>
